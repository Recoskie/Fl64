...
* Analyze the pattern to numbers generated by math functions like tanh, square root, logarithm.<br />

* Warning: you must download the files in AI-Mat to folder your self.
------------------------------------------------------------------------------
  Code_App allows you to run and test example code using the library.
